...
function laveo_customizer_get_default( $setting ) {
 ...
 * @return mixed $default
 */
function laveo_customizer_get_choices( $setting ) {
 ...
 * @return array
 */
function laveo_customizer_hex_to_rgb( $hex ) {
 ...
 * @return mixed $default
 */
function laveo_customizer_remove_theme_mods() {

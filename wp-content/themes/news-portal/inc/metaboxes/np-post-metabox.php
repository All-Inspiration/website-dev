...
?>
		<div class="np-meta-container np-clearfix">
			<ul class="np-meta-menu-wrapper">
				<li class="np-meta-tab <?php if( $post_identity_value == 'np-metabox-info' ) { echo 'active'; } ?>" data-tab="np-metabox-info"><span class="dashicons dashicons-clipboard"></span><?php _e( 'Information', 'news-portal' ); ?></li>
				<li class="np-meta-tab <?php if( $post_identity_value == 'np-metabox-sidebar' ) { echo 'active'; } ?>" data-tab="np-metabox-sidebar"><span class="dashicons dashicons-exerpt-view"></span><?php _e( 'Sidebars', 'news-portal' ); ?></li>
			...
			<div class="np-metabox-content-wrapper">
				...
				<div class="np-single-meta active" id="np-metabox-info">
					<div class="content-header">
						<h4><?php _e( 'About Metabox Options', 'news-portal' ) ;?></h4>
					</div><!-- .content-header -->
				...
				<div class="np-single-meta" id="np-metabox-sidebar">
					<div class="content-header">
						<h4><?php _e( 'Available Sidebars', 'news-portal' ) ;?></h4>
						<span class="section-desc"><em><?php _e( 'Select sidebar from available options which replaced sidebar layout from customizer settings.', 'news-portal' ); ?></em></span>
					</div><!-- .content-header -->
					<div class="np-meta-options-wrap">
						<div class="buttonset">
			                ...
			                ?>
			                    	<input type="radio" id="<?php echo esc_attr( $field['id'] ); ?>" value="<?php echo $field['value']; ?>" name="np_single_post_sidebar" <?php checked( $field['value'], $news_portal_post_sidebar ); if( empty( $news_portal_post_sidebar ) && $field['value'] == 'default_sidebar' ){ echo "checked='checked'";}  ?> />

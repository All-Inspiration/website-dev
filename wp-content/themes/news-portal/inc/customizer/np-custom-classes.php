    ...
    ?>
            <label>
                ...
                <div class="switch_options">
                    ...
                    ?>
                    <input type="hidden" id="mt_switch_option" <?php $this->link(); ?> value="<?php echo $this->value(); ?>" />
                </div>
            </label>
    <?php
        }
...
/*-----------------------------------------------------------------------------------------------------------------------*/
    ...
    <?php
        ...
        ?>
            ...
            ?>
                <div class="np-repeater-field np-repeater-type-<?php echo esc_attr( $field['type'] ).' '.$class; ?>">
                    ...
                    switch ( $field['type'] ) {
                        ...
                        case 'social_icon':
                            ...
                            foreach ( $news_portal_font_awesome_social_icon_array as $news_portal_font_awesome_icon ) {
                                ...
                                echo '<li class='.$icon_class.'><i class="'.$news_portal_font_awesome_icon.'"></i></li>';
                            }
                            echo '</ul>';
                ...
                <div class="np-clearfix np-repeater-footer">
                    ...
                    <a class="np-repeater-field-remove" href="#remove"><?php _e( 'Delete', 'news-portal' ) ?></a> |
                    <a class="np-repeater-field-close" href="#close"><?php _e( 'Close', 'news-portal' ) ?></a>
                    </div>
                </div>
            </div>
            </li>

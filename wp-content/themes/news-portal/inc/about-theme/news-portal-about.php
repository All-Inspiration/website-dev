...
class News_Portal_About {
	...
	public static function hide_notices() {
		if ( isset( $_GET['news-portal-hide-notice'] ) && isset( $_GET['_news_portal_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_news_portal_notice_nonce'], 'news_portal_hide_notices_nonce' ) ) {
				wp_die( __( 'Action failed. Please refresh the page and retry.', 'news-portal' ) );
			}

			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( __( 'Cheat in &#8217; huh?', 'news-portal' ) );
			}
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated news-portal-message">
			...
			<p><?php printf( esc_html__( 'Welcome! Thank you for choosing news portal! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'news-portal' ), '<a href="' . esc_url( admin_url( 'themes.php?page=news-portal-welcome' ) ) . '">', '</a>' ); ?></p>
			<p class="submit">
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'news-portal' ); ?></a></p>
					</div>
					...
					<div class="col">
						<h3> <?php echo esc_html( 'Translate', 'news-portal' ).' '.esc_html( $theme_name ); ?> </h3>
						<p><?php esc_html_e( 'Click below to translate this theme into your own language.', 'news-portal' ) ?></p>
						<p>
							<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/news-portal' ); ?>" class="button button-secondary" target="_blank"><?php echo esc_html( 'Translate', 'news-portal' ).' '.esc_html( $theme_name ); ?></a>
						</p>
					</div>
				</div>
			</div><!-- .point-releases -->

...
Manta WordPress Theme, Copyright 2016-2017 PremiumWP
Manta is distributed under the terms of the GNU GPL
...
Manta WordPress Theme is based on Underscores, (C) 2012-2015 Automattic, Inc.
Licenses: [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
Source: http://underscores.me/

Manta WordPress Theme incorporates code from Twenty Fifteen WordPress Theme, Copyright 2014-2017 WordPress.org & Automattic.com
Twenty Fifteen is distributed under the terms of the GNU GPL.

Manta WordPress Theme incorporates code from Twenty Seventeen WordPress Theme, Copyright 2016-2017 WordPress.org & Automattic.com
Twenty Fifteen is distributed under the terms of the GNU GPL.

Manta WordPress Theme incorporates code from Stargazer WordPress Theme, Copyright (c) 2013 - 2017, Justin Tadlock http://themehybrid.com/themes/stargazer.
Stargazer WordPress Theme is distributed under the terms of the GNU GPL.

== Credits ==
Manta WordPress Theme bundles the following third-party resources:
...
1. Separation of theme specific and reusable code in different folders.
2. Move addons out of core library.
3. Template parts are now part of core library.
4. Remove built-in theme mods and theme settings from template parts.
5. Remove template part for 'menu' and replace it with a menu markup function.
6. Remove template part for 'widgets' and replace it with a widget markup function.
7. Change header and footer entry meta markup methods.
8. Change theme customizer script to make it more extendable and manageable.
9. Inject screen reader text (localize script) to navigation JS using a filter (which makes it possible to alter data on the fly).
10. Replace hard coded element IDs with variable IDs in navigation JS.

= 1.3.1 - Sep 21 2017 =

1. Error Fix: Footer widgets appearing side by side for single widget area.
2. Error Fix: Menu toggle button appearing for footer menu.

= 1.3.2 - Nov 03 2017 =
1. Add: Add full list of google fonts to be used in Manta theme.
2. Modify: Minor modification in site footer text.
3. Optimize sticky navigation script in navigation.js
4. Error Fix: Layout class for custom post types has been set as global.

= 1.3.3 - Dec 05 2017 =
1. Modify: Using core comments navigation function instead of custom template.
2. Modify: Remove wrong conditions for not displaying primary sidebar.
3. Error Fix: Correct wrong file name for singular thumbnail template.
4. Error Fix: Header Items maximum width on medium screens.
5. Modify: Minor improvement in navigation.js
